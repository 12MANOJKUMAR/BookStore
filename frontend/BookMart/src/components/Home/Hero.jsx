...
const Hero = () => {
  return (
    <div className="hero h-screen md:h-[75vh] px-8 flex flex-col md:flex-row justify-center items-center">
      <div className=" mb:mt-10 w-full lg:w-3/6 flex flex-col items-center lg:items-start justify-center  ">
